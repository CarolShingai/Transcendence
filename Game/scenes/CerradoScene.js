// Cena Cerrado: seu Tyrannus se movendo e desviando de carcarás e libelulas (sem harpias).

class CerradoScene extends Phaser.Scene {

  constructor() { super('CerradoScene'); }
  ...
  create() {
    ...
    this._bg1 = this.add.image(W / 2, 0, 'cerrado_bg')
      .setDisplaySize(W, H)
      .setOrigin(0.5, 0)
      .setDepth(-1);

    this._bg2 = this.add.image(W / 2, -H, 'cerrado_bg')
      .setDisplaySize(W, H)
      .setOrigin(0.5, 0)
      .setDepth(-1);
    ...
    this.add.text(W / 2, H - 20, 'FASE: CERRADO', {
      fontSize: '14px',
      fill: '#8B4513'
